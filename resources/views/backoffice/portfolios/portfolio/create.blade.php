        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{ route('portfolio.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('portfolio_type_id') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <select class="form-control" name="portfolio_type_id">
                                    ...
                                    <option @if($portfolio_type->id == old('portfolio_type_id')) selected="selected" @endif value="{{ $portfolio_type->id }}">{{ $portfolio_type->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('services') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="services" class="form-control" value="{{ old('services') }}">
                        ...
                        <div class="form-group {{ $errors->has('dev_icons') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="dev_icons" class="form-control" value="{{ old('dev_icons') }}">
